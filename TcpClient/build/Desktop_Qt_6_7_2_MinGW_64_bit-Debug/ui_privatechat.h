...
public:
    ...
    void setupUi(QWidget *PrivateChat)
    {
        ...
        showMsgte = new QTextEdit(PrivateChat);
        showMsgte->setObjectName("showMsgte");
        QFont font;
        font.setPointSize(16);
        showMsgte->setFont(font);

        verticalLayout->addWidget(showMsgte);
    ...
    void retranslateUi(QWidget *PrivateChat)
    {
        ...
        sendMsg_pb->setText(QCoreApplication::translate("PrivateChat", "\345\217\221\351\200\201\344\277\241\346\201\257", nullptr));
    } // retranslateUi

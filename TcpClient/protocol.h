...
#define DEL_FILE_OK "delete file succeed"
...
#define UPLOAD_FILE_OK "upload file succeed"
#define UPLOAT_FILE_FAILURED "upload file failured"
...
enum ENUM_MSG_TYPE
{
    ...
    ENUM_MSG_TYPE_DOWNLOAD_FILE_REPOND, //下载文件回复
